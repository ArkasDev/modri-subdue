...
from theobald_subdue.T_OrderedSet import OrderedSet
...
def ExtendPattern(parameters, pattern):
    ...
    while extendedInstances:
        ...
        for extendedInstance in extendedInstances:
            ...
            if Graph.GraphMatch(newInstanceGraph, extendedInstanceGraph) and (
            not InstancesOverlap(parameters.overlap, matchingInstances, extendedInstance)):
...
def PatternListInsert(newPattern, patternList, maxLength, valueBased=False):
